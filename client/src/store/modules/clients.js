...
const actions = {
    ...
    async delete({commit, state}, id) {
        ...
        commit("setClients", state.clients.filter((client) => client.id !== id));
    },
...
const getters = {
    ...
    getClient: (state) => (clientId) => JSON.parse(JSON.stringify(state.clients.find((client) => client.id === clientId))),
};
