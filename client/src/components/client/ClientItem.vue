  ...
  <div class="p-6 w-full bg-white shadow rounded">
    <div class="flex justify-between mb-4">
      <div class="flex items-center">
        <img class="w-20 h-20 p-1 mr-4 rounded-full border border-indigo-50" src="/client-placeholder.png"
             alt="{{ name }}">
        <!--        <img class="w-20 h-20 p-1 mr-4 rounded-full border border-indigo-50" src="https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="">-->
        <div>
          <div class="flex mb-2">
